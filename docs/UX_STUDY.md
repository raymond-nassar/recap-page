...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:99-104`, `src/js/main.js:6241-6262`
...
Confidence: Observed
Evidence: `src/js/main.js:5487`, `src/js/main.js:2700-2708`, `src/js/main.js:2727-2743`, against
`src/js/main.js:590-611`
...
Confidence: Observed
Evidence: `src/js/main.js:2727-2743`, `src/js/main.js:5876-5882`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5373-5382`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:435-448`, `src/js/main.js:590-611`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:441-448`
...
Confidence: Observed
Evidence: `src/js/main.js:163`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
