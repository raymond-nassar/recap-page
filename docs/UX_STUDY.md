...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3451-3456` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:104-109`, `src/js/main.js:6213-6234`
...
Confidence: Observed
Evidence: `src/js/main.js:5517`, `src/js/main.js:2709-2717`, `src/js/main.js:2736-2752`, against
`src/js/main.js:598-619`
...
Confidence: Observed
Evidence: `src/js/main.js:2736-2752`, `src/js/main.js:5753-5759`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3575-3601`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:920-931`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5402-5411`.
...
keyboard focus and Escape handling at `src/js/main.js:3470-3554`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:440-453`, `src/js/main.js:598-619`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:446-453`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1658-1660`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3400-3405`, `src/js/main.js:3451-3456`
...
`src/styles.css:723`, `src/js/main.js:2599-2602`.
...
Confidence: Observed
Evidence: `src/js/main.js:3575-3601`, `src/index.html:300-301`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:525`, `src/styles.css:1568-1570`.
...
`src/js/main.js:1689-1728`, `test/ux-completion.test.js:64-76`.
...
src/ returning no matches`, `src/js/main.js:1634-1687`,
...
Confidence: Observed
Evidence: `src/js/main.js:168`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3404-3405` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2462-2496`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3404-3405`.
