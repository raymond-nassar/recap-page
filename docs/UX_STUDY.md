...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2578-2583` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:85-90`, `src/js/main.js:4745-4764`
...
Confidence: Observed
Evidence: `src/js/main.js:4022`, `src/js/main.js:1868-1876`, `src/js/main.js:1895-1911`, against
`src/js/main.js:498-519`
...
Confidence: Observed
Evidence: `src/js/main.js:1895-1911`, `src/js/main.js:4395-4401`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:333`, `src/js/main.js:2609-2632`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:783-794`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:411-417`, `src/js/main.js:3923-3932`.
...
`src/styles.css:104-110`, `src/index.html:333`
...
`docs/ux-artifacts/pa11y-reading-seeded.json`, `src/index.html:306-341`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:347-360`, `src/js/main.js:498-519`, `src/index.html:21`,
`src/index.html:148`, `src/index.html:485`
...
imported
Confidence: Measured
Evidence: `docs/ux-artifacts/pa11y-landing.json`, `src/index.html:306-341`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1220-1222`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2518-2523`, `src/js/main.js:2578-2583`
...
`src/styles.css:651`, `src/js/main.js:1767-1770`.
...
Confidence: Observed
Evidence: `src/js/main.js:2609-2632`, `src/index.html:333`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:486`, `src/styles.css:1399-1401`.
...
src/ returning no matches`, `src/js/main.js:1207-1227`,
...
Confidence: Observed
Evidence: `src/js/main.js:116`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Reading style | Follows a long curated order end to end rather than dipping in | Strong. The product is built around order, resume and next-unread rather than around browsing. `src/index.html:306-341` | When a list is abandoned partway, what caused it? |
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2522-2523` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:440-444`, `PRODUCT_BACKLOG.md:13121` | If sync existed and was opt-in, would you turn it on? |
...
* When I finish an issue in the Marvel Unlimited reader, I want to mark it read and be shown the
  ...
  `src/index.html:306-341` and `src/index.html:333`.
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1649-1682`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2522-2523`.
