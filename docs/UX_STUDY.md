...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2863-2868` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:87-92`, `src/js/main.js:4997-5019`
...
Confidence: Observed
Evidence: `src/js/main.js:4272`, `src/js/main.js:2153-2161`, `src/js/main.js:2180-2196`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2180-2196`, `src/js/main.js:4647-4653`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:376`, `src/js/main.js:2894-2917`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:462-468`, `src/js/main.js:4172-4181`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1224-1226`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2803-2808`, `src/js/main.js:2863-2868`
...
`src/styles.css:645`, `src/js/main.js:2052-2055`.
...
Confidence: Observed
Evidence: `src/js/main.js:2894-2917`, `src/index.html:376`
...
src/ returning no matches`, `src/js/main.js:1209-1231`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2807-2808` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:434-438`, `PRODUCT_BACKLOG.md:12886` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1934-1967`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2807-2808`.
