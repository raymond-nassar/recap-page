...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3499-3504` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6290-6311`
...
Confidence: Observed
Evidence: `src/js/main.js:5536`, `src/js/main.js:2757-2765`, `src/js/main.js:2784-2800`, against
`src/js/main.js:607-628`
...
Confidence: Observed
Evidence: `src/js/main.js:2784-2800`, `src/js/main.js:5925-5931`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3623-3649`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5422-5431`.
...
keyboard focus and Escape handling at `src/js/main.js:3518-3602`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:452-465`, `src/js/main.js:607-628`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:458-465`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1707-1709`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3448-3453`, `src/js/main.js:3499-3504`
...
`src/styles.css:701`, `src/js/main.js:2647-2650`.
...
Confidence: Observed
Evidence: `src/js/main.js:3623-3649`, `src/index.html:300-301`
...
`src/js/main.js:1738-1777`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1683-1736`,
...
Confidence: Observed
Evidence: `src/js/main.js:180`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3452-3453` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2524-2557`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3452-3453`.
