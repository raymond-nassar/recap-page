...
Confidence: Observed
Evidence: `src/js/main.js:1854`, `src/js/views/reading.js:339-347`, `src/js/views/reading.js:364-378`, against
...
Confidence: Observed
Evidence: `src/js/views/reading.js:364-378`, `src/js/views/data.js:186-191`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:307-308`, `src/js/views/reading.js:964-983`
...
keyboard focus and Escape handling at `src/js/views/reading.js:868-949`.
...
Confidence: Observed
Evidence: `src/js/views/reading.js:795-798`, `src/js/views/reading.js:33-38`
...
`src/styles.css:894`, `src/js/views/reading.js:276-279`.
...
Confidence: Observed
Evidence: `src/js/views/reading.js:964-983`, `src/index.html:307-308`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/views/reading.js:799-800` | Would you rather see a guess or a clearly marked gap? |
...
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/views/reading.js:799-800`.
