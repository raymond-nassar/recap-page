...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2807-2812` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:95-100`, `src/js/main.js:3642-3661`
...
Confidence: Observed
Evidence: `src/js/main.js:3209`, `src/js/main.js:2065-2073`, `src/js/main.js:2092-2108`, against
`src/js/main.js:528-549`
...
Confidence: Observed
Evidence: `src/js/main.js:2092-2108`, `src/js/views/data.js:186-191`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:2931-2957`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/views/catalog.js:231-260`.
...
keyboard focus and Escape handling at `src/js/main.js:2826-2910`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:370-383`, `src/js/main.js:528-549`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:376-383`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1580-1582`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2756-2761`, `src/js/main.js:2807-2812`
...
`src/styles.css:723`, `src/js/main.js:1955-1958`.
...
Confidence: Observed
Evidence: `src/js/main.js:2931-2957`, `src/index.html:300-301`
...
`src/js/main.js:1601-1651`, `test/ux-completion.test.js:68-80`.
...
src/ returning no matches`, `src/js/main.js:1558-1609`,
...
Confidence: Observed
Evidence: `src/js/main.js:159`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2760-2761` | Would you rather see a guess or a clearly marked gap? |
...
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2760-2761`.
