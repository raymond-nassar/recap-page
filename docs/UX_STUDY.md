...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3154-3159` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:103-108`, `src/js/main.js:5909-5930`
...
Confidence: Observed
Evidence: `src/js/main.js:5213`, `src/js/main.js:2412-2420`, `src/js/main.js:2439-2455`, against
`src/js/main.js:595-616`
...
Confidence: Observed
Evidence: `src/js/main.js:2439-2455`, `src/js/main.js:5449-5455`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3278-3304`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5098-5107`.
...
keyboard focus and Escape handling at `src/js/main.js:3173-3257`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:437-450`, `src/js/main.js:595-616`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:443-450`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1651-1653`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3103-3108`, `src/js/main.js:3154-3159`
...
`src/styles.css:723`, `src/js/main.js:2302-2305`.
...
Confidence: Observed
Evidence: `src/js/main.js:3278-3304`, `src/index.html:300-301`
...
`src/js/main.js:1672-1722`, `test/ux-completion.test.js:64-76`.
...
src/ returning no matches`, `src/js/main.js:1629-1680`,
...
Confidence: Observed
Evidence: `src/js/main.js:167`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3107-3108` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2165-2199`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3107-3108`.
