...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2726-2731` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:85-90`, `src/js/main.js:4910-4929`
...
Confidence: Observed
Evidence: `src/js/main.js:4187`, `src/js/main.js:2016-2024`, `src/js/main.js:2043-2059`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2043-2059`, `src/js/main.js:4560-4566`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:287`, `src/js/main.js:2757-2780`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:401-407`, `src/js/main.js:4088-4097`.
...
Confidence: Observed
Evidence: `src/js/main.js:2666-2671`, `src/js/main.js:2726-2731`
...
`src/styles.css:655`, `src/js/main.js:1915-1918`.
...
Confidence: Observed
Evidence: `src/js/main.js:2757-2780`, `src/index.html:287`
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2670-2671` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1797-1830`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2670-2671`.
