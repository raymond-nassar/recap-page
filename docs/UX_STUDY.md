...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3439-3444` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6230-6251`
...
Confidence: Observed
Evidence: `src/js/main.js:5476`, `src/js/main.js:2697-2705`, `src/js/main.js:2724-2740`, against
`src/js/main.js:587-608`
...
Confidence: Observed
Evidence: `src/js/main.js:2724-2740`, `src/js/main.js:5865-5871`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3563-3589`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5362-5371`.
...
keyboard focus and Escape handling at `src/js/main.js:3458-3542`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:432-445`, `src/js/main.js:587-608`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:438-445`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1647-1649`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3388-3393`, `src/js/main.js:3439-3444`
...
`src/styles.css:701`, `src/js/main.js:2587-2590`.
...
Confidence: Observed
Evidence: `src/js/main.js:3563-3589`, `src/index.html:300-301`
...
`src/js/main.js:1678-1717`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1623-1676`,
...
Confidence: Observed
Evidence: `src/js/main.js:160`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3392-3393` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2464-2497`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3392-3393`.
