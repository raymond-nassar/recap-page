...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3467-3472` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6258-6279`
...
Confidence: Observed
Evidence: `src/js/main.js:5504`, `src/js/main.js:2725-2733`, `src/js/main.js:2752-2768`, against
`src/js/main.js:608-629`
...
Confidence: Observed
Evidence: `src/js/main.js:2752-2768`, `src/js/main.js:5893-5899`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3591-3617`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5390-5399`.
...
keyboard focus and Escape handling at `src/js/main.js:3486-3570`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:453-466`, `src/js/main.js:608-629`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:459-466`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1675-1677`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3416-3421`, `src/js/main.js:3467-3472`
...
`src/styles.css:701`, `src/js/main.js:2615-2618`.
...
Confidence: Observed
Evidence: `src/js/main.js:3591-3617`, `src/index.html:300-301`
...
`src/js/main.js:1706-1745`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1651-1704`,
...
Confidence: Observed
Evidence: `src/js/main.js:181`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3420-3421` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2492-2525`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3420-3421`.
