...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3321-3326` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6112-6133`
...
Confidence: Observed
Evidence: `src/js/main.js:5358`, `src/js/main.js:2579-2587`, `src/js/main.js:2606-2622`, against
`src/js/main.js:577-598`
...
Confidence: Observed
Evidence: `src/js/main.js:2606-2622`, `src/js/main.js:5747-5753`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3445-3471`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5244-5253`.
...
keyboard focus and Escape handling at `src/js/main.js:3340-3424`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:422-435`, `src/js/main.js:577-598`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:428-435`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1529-1531`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3270-3275`, `src/js/main.js:3321-3326`
...
`src/styles.css:701`, `src/js/main.js:2469-2472`.
...
Confidence: Observed
Evidence: `src/js/main.js:3445-3471`, `src/index.html:300-301`
...
`src/js/main.js:1560-1599`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1505-1558`,
...
Confidence: Observed
Evidence: `src/js/main.js:150`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3274-3275` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2346-2379`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3274-3275`.
