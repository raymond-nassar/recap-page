...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2843-2848` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:87-92`, `src/js/main.js:5020-5039`
...
Confidence: Observed
Evidence: `src/js/main.js:4297`, `src/js/main.js:2133-2141`, `src/js/main.js:2160-2176`, against
`src/js/main.js:500-521`
...
Confidence: Observed
Evidence: `src/js/main.js:2160-2176`, `src/js/main.js:4670-4676`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:377`, `src/js/main.js:2874-2897`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:827-838`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:455-461`, `src/js/main.js:4197-4206`.
...
strikethrough, at `src/styles.css:711-712`. The only opacity left on a read row is on the cover
image at `src/styles.css:714`, which carries no text. Re-measured with six rows actually in the
...
life of the product
Confidence: Measured
Evidence: `src/styles.css:783-784`, `docs/ux-artifacts/live-inspection.json`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:349-362`, `src/js/main.js:500-521`, `src/index.html:21`,
`src/index.html:148`, `src/index.html:529`
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:355-362`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1222-1224`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2783-2788`, `src/js/main.js:2843-2848`
...
`src/styles.css:651`, `src/js/main.js:2032-2035`.
...
Confidence: Observed
Evidence: `src/js/main.js:2874-2897`, `src/index.html:377`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:486`, `src/styles.css:1482-1484`.
...
src/ returning no matches`, `src/js/main.js:1209-1229`,
...
Confidence: Observed
Evidence: `src/js/main.js:118`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2787-2788` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:439-443`, `PRODUCT_BACKLOG.md:13094` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1914-1947`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2787-2788`.
