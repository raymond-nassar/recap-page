...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3476-3481` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:101-106`, `src/js/main.js:6405-6426`
...
Confidence: Observed
Evidence: `src/js/main.js:5542`, `src/js/main.js:2734-2742`, `src/js/main.js:2761-2777`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2761-2777`, `src/js/main.js:5945-5951`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3600-3626`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5427-5436`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1655-1657`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3425-3430`, `src/js/main.js:3476-3481`
...
`src/styles.css:723`, `src/js/main.js:2624-2627`.
...
Confidence: Observed
Evidence: `src/js/main.js:3600-3626`, `src/index.html:300-301`
...
`src/js/main.js:1686-1725`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1631-1684`,
...
Confidence: Observed
Evidence: `src/js/main.js:165`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3429-3430` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2487-2521`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3429-3430`.
