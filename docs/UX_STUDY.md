...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3220-3225` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:95-100`, `src/js/main.js:5993-6014`
...
Confidence: Observed
Evidence: `src/js/main.js:5254`, `src/js/main.js:2478-2486`, `src/js/main.js:2505-2521`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2505-2521`, `src/js/main.js:5643-5649`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3344-3370`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5140-5149`.
...
keyboard focus and Escape handling at `src/js/main.js:3239-3323`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1428-1430`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3169-3174`, `src/js/main.js:3220-3225`
...
`src/styles.css:701`, `src/js/main.js:2368-2371`.
...
Confidence: Observed
Evidence: `src/js/main.js:3344-3370`, `src/index.html:300-301`
...
`src/js/main.js:1459-1498`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1404-1457`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3173-3174` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2245-2278`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3173-3174`.
