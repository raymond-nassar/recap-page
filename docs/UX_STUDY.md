...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3385-3390` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6176-6197`
...
Confidence: Observed
Evidence: `src/js/main.js:5422`, `src/js/main.js:2643-2651`, `src/js/main.js:2670-2686`, against
`src/js/main.js:579-600`
...
Confidence: Observed
Evidence: `src/js/main.js:2670-2686`, `src/js/main.js:5811-5817`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3509-3535`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5308-5317`.
...
keyboard focus and Escape handling at `src/js/main.js:3404-3488`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:424-437`, `src/js/main.js:579-600`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:430-437`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1593-1595`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3334-3339`, `src/js/main.js:3385-3390`
...
`src/styles.css:701`, `src/js/main.js:2533-2536`.
...
Confidence: Observed
Evidence: `src/js/main.js:3509-3535`, `src/index.html:300-301`
...
`src/js/main.js:1624-1663`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1569-1622`,
...
Confidence: Observed
Evidence: `src/js/main.js:152`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3338-3339` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2410-2443`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3338-3339`.
