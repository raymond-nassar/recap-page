...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3282-3287` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6073-6094`
...
Confidence: Observed
Evidence: `src/js/main.js:5319`, `src/js/main.js:2540-2548`, `src/js/main.js:2567-2583`, against
`src/js/main.js:576-597`
...
Confidence: Observed
Evidence: `src/js/main.js:2567-2583`, `src/js/main.js:5708-5714`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3406-3432`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5205-5214`.
...
keyboard focus and Escape handling at `src/js/main.js:3301-3385`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:421-434`, `src/js/main.js:576-597`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:427-434`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1490-1492`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3231-3236`, `src/js/main.js:3282-3287`
...
`src/styles.css:701`, `src/js/main.js:2430-2433`.
...
Confidence: Observed
Evidence: `src/js/main.js:3406-3432`, `src/index.html:300-301`
...
`src/js/main.js:1521-1560`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1466-1519`,
...
Confidence: Observed
Evidence: `src/js/main.js:149`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3235-3236` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2307-2340`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3235-3236`.
