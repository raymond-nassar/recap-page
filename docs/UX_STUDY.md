...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3444-3449` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:100-105`, `src/js/main.js:6246-6267`
...
Confidence: Observed
Evidence: `src/js/main.js:5492`, `src/js/main.js:2702-2710`, `src/js/main.js:2729-2745`, against
`src/js/main.js:591-612`
...
Confidence: Observed
Evidence: `src/js/main.js:2729-2745`, `src/js/main.js:5881-5887`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3568-3594`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:900-911`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5378-5387`.
...
`src/styles.css:104-110`, `src/index.html:300-301`
...
alpha at `src/styles.css:555-562`. Sampling the rendered background across all eight catalog
...
keyboard focus and Escape handling at `src/js/main.js:3463-3547`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:436-449`, `src/js/main.js:591-612`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:442-449`
...
Confidence: Observed
Evidence: `src/js/main.js:3393-3398`, `src/js/main.js:3444-3449`
...
`src/styles.css:701`, `src/js/main.js:2592-2595`.
...
Confidence: Observed
Evidence: `src/js/main.js:3568-3594`, `src/index.html:300-301`
...
`src/js/main.js:1682-1721`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1627-1680`,
...
Confidence: Observed
Evidence: `src/js/main.js:164`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3397-3398` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2468-2502`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3397-3398`.
