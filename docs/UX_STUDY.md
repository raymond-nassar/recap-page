...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3471-3476` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6262-6283`
...
Confidence: Observed
Evidence: `src/js/main.js:5508`, `src/js/main.js:2729-2737`, `src/js/main.js:2756-2772`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2756-2772`, `src/js/main.js:5897-5903`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3595-3621`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5394-5403`.
...
keyboard focus and Escape handling at `src/js/main.js:3490-3574`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1679-1681`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3420-3425`, `src/js/main.js:3471-3476`
...
`src/styles.css:701`, `src/js/main.js:2619-2622`.
...
Confidence: Observed
Evidence: `src/js/main.js:3595-3621`, `src/index.html:300-301`
...
`src/js/main.js:1710-1749`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1655-1708`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3424-3425` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2496-2529`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3424-3425`.
