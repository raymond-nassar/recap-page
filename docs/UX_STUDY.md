...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2742-2747` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:86-91`, `src/js/main.js:4955-4975`
...
Confidence: Observed
Evidence: `src/js/main.js:4232`, `src/js/main.js:2032-2040`, `src/js/main.js:2059-2075`, against
`src/js/main.js:502-523`
...
Confidence: Observed
Evidence: `src/js/main.js:2059-2075`, `src/js/main.js:4605-4611`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:287`, `src/js/main.js:2773-2796`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:401-407`, `src/js/main.js:4125-4134`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:348-361`, `src/js/main.js:502-523`, `src/index.html:21`,
...
Confidence: Observed
Evidence: `src/js/main.js:2682-2687`, `src/js/main.js:2742-2747`
...
Confidence: Observed
Evidence: `src/js/main.js:2773-2796`, `src/index.html:287`
...
src/ returning no matches`, `src/js/main.js:1211-1252`,
...
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:445-449`, `PRODUCT_BACKLOG.md:13314` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1813-1846`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2686-2687`.
