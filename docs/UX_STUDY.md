...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2741-2746` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:85-90`, `src/js/main.js:4925-4944`
...
Confidence: Observed
Evidence: `src/js/main.js:4202`, `src/js/main.js:2031-2039`, `src/js/main.js:2058-2074`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2058-2074`, `src/js/main.js:4575-4581`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:287`, `src/js/main.js:2772-2795`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:808-819`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:401-407`, `src/js/main.js:4103-4112`.
...
strikethrough, at `src/styles.css:715-716`. The only opacity left on a read row is on the cover
image at `src/styles.css:718`, which carries no text. Re-measured with six rows actually in the
...
life of the product
Confidence: Measured
Evidence: `src/styles.css:787-788`, `docs/ux-artifacts/live-inspection.json`
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:347-360`, `src/js/main.js:501-522`, `src/index.html:21`,
`src/index.html:102`, `src/index.html:510`
...
Confidence: Observed
Evidence: `src/js/main.js:2681-2686`, `src/js/main.js:2741-2746`
...
`src/styles.css:655`, `src/js/main.js:1930-1933`.
...
Confidence: Observed
Evidence: `src/js/main.js:2772-2795`, `src/index.html:287`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:490`, `src/styles.css:1424-1426`.
...
src/ returning no matches`, `src/js/main.js:1210-1232`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2685-2686` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:440-444`, `PRODUCT_BACKLOG.md:13145` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1812-1845`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2685-2686`.
