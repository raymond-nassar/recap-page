...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2864-2869` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:93-98`, `src/js/main.js:3965-3984`
...
Confidence: Observed
Evidence: `src/js/main.js:3266`, `src/js/main.js:2122-2130`, `src/js/main.js:2149-2165`, against
`src/js/main.js:585-606`
...
Confidence: Observed
Evidence: `src/js/main.js:2149-2165`, `src/js/main.js:3505-3511`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:2988-3014`
...
keyboard focus and Escape handling at `src/js/main.js:2883-2967`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:427-440`, `src/js/main.js:585-606`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:433-440`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1637-1639`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2813-2818`, `src/js/main.js:2864-2869`
...
`src/styles.css:723`, `src/js/main.js:2012-2015`.
...
Confidence: Observed
Evidence: `src/js/main.js:2988-3014`, `src/index.html:300-301`
...
`src/js/main.js:1658-1708`, `test/ux-completion.test.js:68-80`.
...
src/ returning no matches`, `src/js/main.js:1615-1666`,
...
Confidence: Observed
Evidence: `src/js/main.js:157`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2817-2818` | Would you rather see a guess or a clearly marked gap? |
...
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2817-2818`.
