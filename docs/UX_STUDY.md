...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:4898-4919`
...
Confidence: Observed
Evidence: `src/js/main.js:4199`, `src/js/main.js:2125-2133`, `src/js/main.js:2152-2168`, against
`src/js/main.js:588-609`
...
Confidence: Observed
Evidence: `src/js/main.js:2152-2168`, `src/js/main.js:4438-4444`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:2991-3017`
...
keyboard focus and Escape handling at `src/js/main.js:2886-2970`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:430-443`, `src/js/main.js:588-609`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:436-443`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1640-1642`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2816-2821`, `src/js/main.js:2867-2872`
...
`src/styles.css:723`, `src/js/main.js:2015-2018`.
...
Confidence: Observed
Evidence: `src/js/main.js:2991-3017`, `src/index.html:300-301`
...
`src/js/main.js:1661-1711`, `test/ux-completion.test.js:66-78`.
...
src/ returning no matches`, `src/js/main.js:1618-1669`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2820-2821` | Would you rather see a guess or a clearly marked gap? |
...
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2820-2821`.
