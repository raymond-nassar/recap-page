...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:80-85`, `src/js/main.js:2451-2471`
...
Confidence: Observed
Evidence: `src/js/main.js:1819`, `src/js/views/reading.js:246-254`, `src/js/views/reading.js:271-285`, against
...
blocked one
Confidence: Observed
Evidence: `src/index.html:305-306`, `src/js/views/reading.js:853-872`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:923-934`, covering Enter,
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1441-1443`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/views/reading.js:681-684`, `src/js/views/reading.js:30-35`
...
Confidence: Observed
Evidence: `src/js/views/reading.js:853-872`, `src/index.html:305-306`
...
`src/js/main.js:1472-1511`, `test/ux-completion.test.js:69-80`.
...
src/ returning no matches`, `src/js/main.js:1418-1469`,
...
Confidence: Observed
Evidence: `src/js/views/reading.js:137`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
