...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3442-3447` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6233-6254`
...
Confidence: Observed
Evidence: `src/js/main.js:5479`, `src/js/main.js:2700-2708`, `src/js/main.js:2727-2743`, against
`src/js/main.js:593-614`
...
Confidence: Observed
Evidence: `src/js/main.js:2727-2743`, `src/js/main.js:5868-5874`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3566-3592`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5365-5374`.
...
keyboard focus and Escape handling at `src/js/main.js:3461-3545`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:438-451`, `src/js/main.js:593-614`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:444-451`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1650-1652`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3391-3396`, `src/js/main.js:3442-3447`
...
`src/styles.css:701`, `src/js/main.js:2590-2593`.
...
Confidence: Observed
Evidence: `src/js/main.js:3566-3592`, `src/index.html:300-301`
...
`src/js/main.js:1681-1720`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1626-1679`,
...
Confidence: Observed
Evidence: `src/js/main.js:166`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3395-3396` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2467-2500`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3395-3396`.
