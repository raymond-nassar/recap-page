...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2636-2641` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:90-95`, `src/js/main.js:3467-3486`
...
Confidence: Observed
Evidence: `src/js/main.js:3038`, `src/js/main.js:1894-1902`, `src/js/main.js:1921-1937`, against
...
Confidence: Observed
Evidence: `src/js/main.js:1921-1937`, `src/js/views/data.js:182-187`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:2760-2786`
...
keyboard focus and Escape handling at `src/js/main.js:2655-2739`.
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:369-376`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1409-1411`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2585-2590`, `src/js/main.js:2636-2641`
...
`src/styles.css:723`, `src/js/main.js:1784-1787`.
...
Confidence: Observed
Evidence: `src/js/main.js:2760-2786`, `src/index.html:300-301`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:525`, `src/styles.css:1567-1569`.
...
`src/js/main.js:1430-1480`, `test/ux-completion.test.js:68-80`.
...
src/ returning no matches`, `src/js/main.js:1387-1438`,
...
Confidence: Observed
Evidence: `src/js/main.js:154`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2589-2590` | Would you rather see a guess or a clearly marked gap? |
...
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2589-2590`.
