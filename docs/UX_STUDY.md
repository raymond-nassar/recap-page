...
`src/styles.css:104-110`, `src/index.html:287`
...
`docs/ux-artifacts/pa11y-reading-seeded.json`, `src/index.html:260-295`
...
imported
Confidence: Measured
Evidence: `docs/ux-artifacts/pa11y-landing.json`, `src/index.html:260-295`
...
Resolution evidence: the current Library hub includes both views at `src/index.html:333-366`
...
`src/index.html:42-87`, `src/js/lib/route.js:15-25`.
...
* When I finish an issue in the Marvel Unlimited reader, I want to mark it read and be shown the
  ...
  `src/index.html:260-295` and `src/index.html:287`.
...
* When I follow one crossover, I want its progress counted for that list alone, so I can see how
  ...
  Hypothesis, and the gap behind existing story 4.2. Traced to `src/index.html:370-372`.
...
| Checking progress | Opens Progress by series to see how far through the crossover they are | Confused. Counts include every other list they ever imported | Existing story 4.2, `src/index.html:370-372` |
