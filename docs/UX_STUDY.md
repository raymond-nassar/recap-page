...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3221-3226` |
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300`, `src/js/main.js:3252-3275`
...
Confidence: Observed
Evidence: `src/js/main.js:3161-3166`, `src/js/main.js:3221-3226`
...
`src/styles.css:698`, `src/js/main.js:2364-2367`.
...
Confidence: Observed
Evidence: `src/js/main.js:3252-3275`, `src/index.html:300`
...
`docs/ux-artifacts/live-inspection.json`, `src/styles.css:507`, `src/styles.css:1504-1511`.
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3165-3166` | Would you rather see a guess or a clearly marked gap? |
