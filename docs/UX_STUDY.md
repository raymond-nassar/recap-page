...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2745-2750` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:86-91`, `src/js/main.js:4958-4978`
...
Confidence: Observed
Evidence: `src/js/main.js:4235`, `src/js/main.js:2035-2043`, `src/js/main.js:2062-2078`, against
`src/js/main.js:503-524`
...
Confidence: Observed
Evidence: `src/js/main.js:2062-2078`, `src/js/main.js:4608-4614`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:287`, `src/js/main.js:2776-2799`
...
Backlog item: BL-026
Resolved: BL-026 added the reference to the About view at `src/index.html:825-836`, covering Enter,
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:401-407`, `src/js/main.js:4128-4137`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:348-361`, `src/js/main.js:503-524`, `src/index.html:21`,
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1226-1228`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2685-2690`, `src/js/main.js:2745-2750`
...
`src/styles.css:655`, `src/js/main.js:1934-1937`.
...
Confidence: Observed
Evidence: `src/js/main.js:2776-2799`, `src/index.html:287`
...
src/ returning no matches`, `src/js/main.js:1212-1253`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2689-2690` | Would you rather see a guess or a clearly marked gap? |
| Attitude to cloud services | Actively prefers local-only and treats that as the point | Strong. Recorded as a product constraint and stated in the backlog's own out-of-scope list. `PRODUCT_BACKLOG.md:444-448`, `PRODUCT_BACKLOG.md:13280` | If sync existed and was opt-in, would you turn it on? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1816-1849`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2689-2690`.
