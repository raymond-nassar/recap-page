...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:2760-2765` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:87-92`, `src/js/main.js:4984-5004`
...
Confidence: Observed
Evidence: `src/js/main.js:4261`, `src/js/main.js:2050-2058`, `src/js/main.js:2077-2093`, against
`src/js/main.js:504-525`
...
Confidence: Observed
Evidence: `src/js/main.js:2077-2093`, `src/js/main.js:4634-4640`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:287`, `src/js/main.js:2791-2814`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:401-407`, `src/js/main.js:4154-4163`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1227-1229`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:2700-2705`, `src/js/main.js:2760-2765`
...
`src/styles.css:658`, `src/js/main.js:1949-1952`.
...
Confidence: Observed
Evidence: `src/js/main.js:2791-2814`, `src/index.html:287`
...
src/ returning no matches`, `src/js/main.js:1213-1254`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:2704-2705` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:1831-1864`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:2704-2705`.
