...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3346-3351` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:96-101`, `src/js/main.js:6137-6158`
...
Confidence: Observed
Evidence: `src/js/main.js:5383`, `src/js/main.js:2604-2612`, `src/js/main.js:2631-2647`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2631-2647`, `src/js/main.js:5772-5778`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3470-3496`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5269-5278`.
...
keyboard focus and Escape handling at `src/js/main.js:3365-3449`.
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1554-1556`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3295-3300`, `src/js/main.js:3346-3351`
...
`src/styles.css:701`, `src/js/main.js:2494-2497`.
...
Confidence: Observed
Evidence: `src/js/main.js:3470-3496`, `src/index.html:300-301`
...
`src/js/main.js:1585-1624`, `test/ux-completion.test.js:63-75`.
...
src/ returning no matches`, `src/js/main.js:1530-1583`,
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3299-3300` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2371-2404`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3299-3300`.
