...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:101-106`, `src/js/main.js:6398-6419`
...
Confidence: Observed
Evidence: `src/js/main.js:5535`, `src/js/main.js:2734-2742`, `src/js/main.js:2761-2777`, against
...
Confidence: Observed
Evidence: `src/js/main.js:2761-2777`, `src/js/main.js:5938-5944`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5420-5429`.
