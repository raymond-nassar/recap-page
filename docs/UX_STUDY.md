...
| 2 | Match between the system and the real world | 1 | Strong. Labels are written in reader language, and availability wording hedges rather than promises. `src/js/main.js:3332-3337` |
...
Confidence: Measured
Evidence: `docs/ux-artifacts/render-cost.json`, `src/js/main.js:105-110`, `src/js/main.js:6087-6108`
...
Confidence: Observed
Evidence: `src/js/main.js:5391`, `src/js/main.js:2590-2598`, `src/js/main.js:2617-2633`, against
`src/js/main.js:597-618`
...
Confidence: Observed
Evidence: `src/js/main.js:2617-2633`, `src/js/main.js:5627-5633`
...
blocked one
Confidence: Observed
Evidence: `src/index.html:300-301`, `src/js/main.js:3456-3482`
...
* 3.2.2 On Input passes, overturning a tool result. HTML_CodeSniffer flagged `#form-catalog-search`
  ...
  so the criterion is met. Evidence: `src/index.html:463-469`, `src/js/main.js:5276-5285`.
...
keyboard focus and Escape handling at `src/js/main.js:3351-3435`.
...
blocking
Confidence: Observed
Evidence: `src/js/main.js:439-452`, `src/js/main.js:597-618`, `src/index.html:21`,
...
Backlog item: BL-027
Resolved: which channel a message uses is now read off the container at `src/js/main.js:445-452`
...
`showView` writes it only to `.ri[data-view]` at `src/js/main.js:1653-1655`, and no rail item declares
...
Confidence: Observed
Evidence: `src/js/main.js:3281-3286`, `src/js/main.js:3332-3337`
...
`src/styles.css:723`, `src/js/main.js:2480-2483`.
...
Confidence: Observed
Evidence: `src/js/main.js:3456-3482`, `src/index.html:300-301`
...
`src/js/main.js:1694-1724`, `test/ux-completion.test.js:64-76`.
...
src/ returning no matches`, `src/js/main.js:1631-1682`,
...
Confidence: Observed
Evidence: `src/js/main.js:169`, `src/js/lib/readingFilters.js:25-50`
Source: Step 5 information architecture review, addressability
...
| Tolerance for missing metadata | High, provided the app admits what it does not know | Strong. Pending and by-hand states are surfaced rather than hidden, and this was a deliberate decision. `src/js/main.js:3285-3286` | Would you rather see a guess or a clearly marked gap? |
...
* When I open a crossover I have never read, I want to know how much reading I am committing to
  ...
  `src/js/main.js:2343-2377`.
* When an issue has no metadata yet, I want the app to say so plainly, so I can tell a pending
  lookup apart from a comic that does not exist. Traced to `src/js/main.js:3285-3286`.
