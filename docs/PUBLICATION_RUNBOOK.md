...
- `CHANGELOG.md:4127-4138`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4140-4150`, the released note that the private channel is not switched on.
