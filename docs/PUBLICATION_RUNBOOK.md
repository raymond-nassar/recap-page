...
- `CHANGELOG.md:3786-3794`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3796-3806`, the released note that the private channel is not switched on.
