...
reasoning at `PRODUCT_BACKLOG.md:7099-7103`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6452-6465`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6863-6870`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6929-6931`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6951-6956`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6958-6964`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7025-7031`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7056-7061`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7099-7103`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9203-9208`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2537-2540`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2549-2552`, the released note that the private channel is not switched on.
