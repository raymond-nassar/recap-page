...
- `CHANGELOG.md:1960-1965`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1953-1958`, the released note that the private channel is not switched on.
