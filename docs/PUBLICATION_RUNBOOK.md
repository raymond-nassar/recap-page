...
- `CHANGELOG.md:4055-4066`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4068-4078`, the released note that the private channel is not switched on.
