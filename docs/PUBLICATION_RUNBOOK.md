...
- `CHANGELOG.md:4080-4091`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4093-4103`, the released note that the private channel is not switched on.
