...
- `CHANGELOG.md:4087-4098`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4100-4110`, the released note that the private channel is not switched on.
