...
- `CHANGELOG.md:2910-2921`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2923-2933`, the released note that the private channel is not switched on.
