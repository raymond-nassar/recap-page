...
- `CHANGELOG.md:4142-4153`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4155-4165`, the released note that the private channel is not switched on.
