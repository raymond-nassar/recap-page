...
- `CHANGELOG.md:3966-3977`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3979-3989`, the released note that the private channel is not switched on.
