...
- `CHANGELOG.md:3280-3291`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3293-3303`, the released note that the private channel is not switched on.
