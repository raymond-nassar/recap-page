...
- `CHANGELOG.md:3890-3901`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3903-3913`, the released note that the private channel is not switched on.
