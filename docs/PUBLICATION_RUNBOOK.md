...
- `CHANGELOG.md:4133-4144`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4146-4156`, the released note that the private channel is not switched on.
