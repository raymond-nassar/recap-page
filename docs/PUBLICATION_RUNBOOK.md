...
- `CHANGELOG.md:4050-4061`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4063-4073`, the released note that the private channel is not switched on.
