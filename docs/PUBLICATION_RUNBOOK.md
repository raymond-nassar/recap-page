...
- `CHANGELOG.md:2887-2898`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2900-2910`, the released note that the private channel is not switched on.
