...
- `CHANGELOG.md:4134-4145`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4147-4157`, the released note that the private channel is not switched on.
