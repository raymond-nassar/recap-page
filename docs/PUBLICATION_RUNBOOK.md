...
- `CHANGELOG.md:3572-3583`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3585-3595`, the released note that the private channel is not switched on.
