...
- `CHANGELOG.md:3771-3782`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3784-3794`, the released note that the private channel is not switched on.
