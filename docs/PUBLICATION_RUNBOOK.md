...
- `CHANGELOG.md:3919-3930`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3932-3942`, the released note that the private channel is not switched on.
