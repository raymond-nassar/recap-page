...
- `CHANGELOG.md:4094-4105`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4107-4117`, the released note that the private channel is not switched on.
