...
- `CHANGELOG.md:3286-3297`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3299-3309`, the released note that the private channel is not switched on.
