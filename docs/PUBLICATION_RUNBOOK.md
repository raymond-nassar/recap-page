...
- `CHANGELOG.md:3772-3783`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3785-3795`, the released note that the private channel is not switched on.
