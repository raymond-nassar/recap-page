...
- `CHANGELOG.md:3440-3451`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3453-3463`, the released note that the private channel is not switched on.
