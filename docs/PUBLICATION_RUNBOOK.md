...
- `CHANGELOG.md:4007-4018`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4020-4030`, the released note that the private channel is not switched on.
