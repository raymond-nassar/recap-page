...
- `CHANGELOG.md:3330-3341`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3343-3353`, the released note that the private channel is not switched on.
