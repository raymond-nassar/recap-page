...
- `CHANGELOG.md:3826-3837`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3839-3849`, the released note that the private channel is not switched on.
