...
- `CHANGELOG.md:4048-4059`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4061-4071`, the released note that the private channel is not switched on.
