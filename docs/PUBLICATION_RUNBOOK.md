...
- `CHANGELOG.md:3942-3953`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3955-3965`, the released note that the private channel is not switched on.
