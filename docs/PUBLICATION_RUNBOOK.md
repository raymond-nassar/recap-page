...
- `CHANGELOG.md:3709-3720`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3722-3732`, the released note that the private channel is not switched on.
