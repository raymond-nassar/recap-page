...
- `CHANGELOG.md:4035-4046`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4048-4058`, the released note that the private channel is not switched on.
