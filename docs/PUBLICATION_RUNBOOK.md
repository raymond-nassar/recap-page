...
- `CHANGELOG.md:3406-3417`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3419-3429`, the released note that the private channel is not switched on.
