...
- `CHANGELOG.md:2891-2894`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2903-2906`, the released note that the private channel is not switched on.
