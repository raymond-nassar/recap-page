...
- `CHANGELOG.md:3450-3461`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3463-3473`, the released note that the private channel is not switched on.
