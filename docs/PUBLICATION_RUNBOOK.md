...
- `CHANGELOG.md:2684-2687`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2697-2699`, the released note that the private channel is not switched on.
