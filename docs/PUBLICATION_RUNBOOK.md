...
- `CHANGELOG.md:3066-3077`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3079-3089`, the released note that the private channel is not switched on.
