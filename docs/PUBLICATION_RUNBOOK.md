...
- `CHANGELOG.md:3089-3100`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3102-3112`, the released note that the private channel is not switched on.
