...
- `CHANGELOG.md:3030-3034`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3036-3046`, the released note that the private channel is not switched on.
