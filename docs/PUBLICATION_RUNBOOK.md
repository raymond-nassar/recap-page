...
- `CHANGELOG.md:3323-3334`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3336-3346`, the released note that the private channel is not switched on.
