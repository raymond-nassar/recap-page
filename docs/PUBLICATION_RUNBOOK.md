...
- `CHANGELOG.md:2884-2895`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2897-2907`, the released note that the private channel is not switched on.
