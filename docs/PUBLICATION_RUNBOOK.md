...
- `CHANGELOG.md:4014-4025`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4027-4037`, the released note that the private channel is not switched on.
