...
- `CHANGELOG.md:3680-3691`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3693-3703`, the released note that the private channel is not switched on.
