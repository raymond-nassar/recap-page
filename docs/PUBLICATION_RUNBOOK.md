...
- `CHANGELOG.md:3250-3261`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3263-3273`, the released note that the private channel is not switched on.
