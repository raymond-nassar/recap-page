...
- `CHANGELOG.md:3559-3570`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3572-3582`, the released note that the private channel is not switched on.
