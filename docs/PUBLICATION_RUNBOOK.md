...
- `CHANGELOG.md:4070-4081`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4083-4093`, the released note that the private channel is not switched on.
