...
- `CHANGELOG.md:3671-3682`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3684-3694`, the released note that the private channel is not switched on.
