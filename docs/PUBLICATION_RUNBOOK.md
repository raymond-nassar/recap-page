...
- `CHANGELOG.md:3363-3374`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3376-3386`, the released note that the private channel is not switched on.
