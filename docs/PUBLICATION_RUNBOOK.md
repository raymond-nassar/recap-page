...
- `CHANGELOG.md:2855-2858`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2867-2870`, the released note that the private channel is not switched on.
