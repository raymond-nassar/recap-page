...
- `CHANGELOG.md:4043-4054`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4056-4066`, the released note that the private channel is not switched on.
