...
- `CHANGELOG.md:3534-3545`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3547-3557`, the released note that the private channel is not switched on.
