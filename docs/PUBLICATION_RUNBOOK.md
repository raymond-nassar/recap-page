...
- `CHANGELOG.md:2920-2931`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2933-2943`, the released note that the private channel is not switched on.
