...
- `CHANGELOG.md:3059-3070`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3072-3082`, the released note that the private channel is not switched on.
