...
- `CHANGELOG.md:3819-3830`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3832-3842`, the released note that the private channel is not switched on.
