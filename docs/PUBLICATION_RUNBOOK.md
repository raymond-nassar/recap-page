...
- `CHANGELOG.md:2332-2335`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2344-2347`, the released note that the private channel is not switched on.
