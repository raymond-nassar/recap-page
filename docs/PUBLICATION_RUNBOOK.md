...
- `CHANGELOG.md:3120-3131`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3133-3143`, the released note that the private channel is not switched on.
