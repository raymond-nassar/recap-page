...
- `CHANGELOG.md:3143-3154`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3156-3166`, the released note that the private channel is not switched on.
