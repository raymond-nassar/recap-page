...
- `CHANGELOG.md:2952-2955`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1715-1718`, the released note that the private channel is not switched on.
