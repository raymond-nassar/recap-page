...
- `CHANGELOG.md:4059-4070`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4072-4082`, the released note that the private channel is not switched on.
