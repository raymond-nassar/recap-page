...
- `CHANGELOG.md:3872-3883`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3885-3895`, the released note that the private channel is not switched on.
