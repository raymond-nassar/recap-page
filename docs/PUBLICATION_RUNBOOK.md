...
- `CHANGELOG.md:3924-3935`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3937-3947`, the released note that the private channel is not switched on.
