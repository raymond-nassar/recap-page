...
- `CHANGELOG.md:3047-3058`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3060-3070`, the released note that the private channel is not switched on.
