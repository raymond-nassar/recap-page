...
- `CHANGELOG.md:4152-4163`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4165-4175`, the released note that the private channel is not switched on.
