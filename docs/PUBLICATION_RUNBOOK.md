...
- `CHANGELOG.md:3736-3747`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3749-3759`, the released note that the private channel is not switched on.
