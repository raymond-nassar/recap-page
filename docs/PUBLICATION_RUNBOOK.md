...
- `CHANGELOG.md:4021-4032`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4034-4044`, the released note that the private channel is not switched on.
