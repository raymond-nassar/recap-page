...
- `CHANGELOG.md:3393-3404`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3406-3416`, the released note that the private channel is not switched on.
