...
- `CHANGELOG.md:3522-3533`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3535-3545`, the released note that the private channel is not switched on.
