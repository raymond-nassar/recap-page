...
- `CHANGELOG.md:3699-3710`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3712-3722`, the released note that the private channel is not switched on.
