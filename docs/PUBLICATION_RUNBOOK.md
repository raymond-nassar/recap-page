...
- `CHANGELOG.md:3490-3501`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3503-3513`, the released note that the private channel is not switched on.
