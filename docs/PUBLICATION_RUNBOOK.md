...
- `CHANGELOG.md:3006-3010`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3012-3022`, the released note that the private channel is not switched on.
