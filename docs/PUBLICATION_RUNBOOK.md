...
- `CHANGELOG.md:3800-3811`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3813-3823`, the released note that the private channel is not switched on.
