...
- `CHANGELOG.md:3217-3221`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3229-3233`, the released note that the private channel is not switched on.
