...
- `CHANGELOG.md:3651-3662`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3664-3674`, the released note that the private channel is not switched on.
