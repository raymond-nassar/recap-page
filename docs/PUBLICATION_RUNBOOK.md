...
- `CHANGELOG.md:3268-3279`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3281-3291`, the released note that the private channel is not switched on.
