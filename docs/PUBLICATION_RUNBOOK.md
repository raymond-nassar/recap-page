...
- `CHANGELOG.md:3605-3616`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3618-3628`, the released note that the private channel is not switched on.
