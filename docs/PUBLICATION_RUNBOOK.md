...
- `CHANGELOG.md:4064-4075`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4077-4087`, the released note that the private channel is not switched on.
