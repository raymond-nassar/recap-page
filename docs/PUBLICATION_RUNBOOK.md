...
- `CHANGELOG.md:3760-3771`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3773-3783`, the released note that the private channel is not switched on.
