...
- `CHANGELOG.md:2349-2352`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2361-2364`, the released note that the private channel is not switched on.
