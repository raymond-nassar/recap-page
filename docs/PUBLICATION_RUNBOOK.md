...
- `CHANGELOG.md:3416-3427`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3429-3439`, the released note that the private channel is not switched on.
