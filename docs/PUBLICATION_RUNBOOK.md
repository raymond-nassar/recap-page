...
- `CHANGELOG.md:3113-3124`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3126-3136`, the released note that the private channel is not switched on.
