...
- `CHANGELOG.md:3814-3825`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3827-3837`, the released note that the private channel is not switched on.
