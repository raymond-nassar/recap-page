...
- `CHANGELOG.md:3594-3605`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3607-3617`, the released note that the private channel is not switched on.
