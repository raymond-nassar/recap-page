...
- `CHANGELOG.md:3814-3822`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3824-3834`, the released note that the private channel is not switched on.
