...
- `CHANGELOG.md:3191-3202`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3204-3214`, the released note that the private channel is not switched on.
