...
- `CHANGELOG.md:3171-3182`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3184-3194`, the released note that the private channel is not switched on.
