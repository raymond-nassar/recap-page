...
- `CHANGELOG.md:3409-3420`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3422-3432`, the released note that the private channel is not switched on.
