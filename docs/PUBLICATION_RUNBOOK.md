...
- `CHANGELOG.md:2874-2885`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2887-2897`, the released note that the private channel is not switched on.
