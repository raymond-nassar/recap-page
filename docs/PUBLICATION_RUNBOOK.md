...
- `CHANGELOG.md:3308-3319`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3321-3331`, the released note that the private channel is not switched on.
