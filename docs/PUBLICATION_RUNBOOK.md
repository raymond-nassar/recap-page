...
- `CHANGELOG.md:3950-3961`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3963-3973`, the released note that the private channel is not switched on.
