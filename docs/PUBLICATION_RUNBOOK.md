...
- `CHANGELOG.md:4169-4180`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4182-4192`, the released note that the private channel is not switched on.
