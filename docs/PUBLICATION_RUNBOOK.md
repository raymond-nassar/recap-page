...
- `CHANGELOG.md:3279-3290`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3292-3302`, the released note that the private channel is not switched on.
