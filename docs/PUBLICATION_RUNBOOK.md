...
- `CHANGELOG.md:2937-2945`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2960-2971`, the released note that the private channel is not switched on.
