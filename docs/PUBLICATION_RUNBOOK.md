...
- `CHANGELOG.md:3878-3889`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3891-3901`, the released note that the private channel is not switched on.
