...
- `CHANGELOG.md:2905-2916`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2918-2928`, the released note that the private channel is not switched on.
