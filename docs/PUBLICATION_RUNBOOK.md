...
- `CHANGELOG.md:2880-2883`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2892-2895`, the released note that the private channel is not switched on.
