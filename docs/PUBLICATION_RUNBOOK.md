...
- `CHANGELOG.md:2596-2599`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2608-2611`, the released note that the private channel is not switched on.
