...
- `CHANGELOG.md:3034-3045`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3047-3057`, the released note that the private channel is not switched on.
