...
- `CHANGELOG.md:3337-3348`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3350-3360`, the released note that the private channel is not switched on.
