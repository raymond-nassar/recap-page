...
- `CHANGELOG.md:1983-1988`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1976-1981`, the released note that the private channel is not switched on.
