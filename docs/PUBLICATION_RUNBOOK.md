...
- `CHANGELOG.md:3993-4004`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4006-4016`, the released note that the private channel is not switched on.
