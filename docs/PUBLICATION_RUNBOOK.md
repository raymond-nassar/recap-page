...
- `CHANGELOG.md:3077-3088`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3090-3100`, the released note that the private channel is not switched on.
