...
- `CHANGELOG.md:3070-3081`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3083-3093`, the released note that the private channel is not switched on.
