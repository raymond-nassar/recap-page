...
- `CHANGELOG.md:3980-3991`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3993-4003`, the released note that the private channel is not switched on.
