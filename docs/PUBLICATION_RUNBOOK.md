...
- `CHANGELOG.md:3987-3998`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4000-4010`, the released note that the private channel is not switched on.
