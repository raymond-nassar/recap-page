...
- `CHANGELOG.md:4100-4111`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4113-4123`, the released note that the private channel is not switched on.
