...
- `CHANGELOG.md:3851-3862`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3864-3874`, the released note that the private channel is not switched on.
