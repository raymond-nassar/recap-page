...
- `CHANGELOG.md:4000-4011`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4013-4023`, the released note that the private channel is not switched on.
