...
- `CHANGELOG.md:3865-3876`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3878-3888`, the released note that the private channel is not switched on.
