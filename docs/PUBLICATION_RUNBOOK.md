...
- `CHANGELOG.md:2586-2589`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2598-2601`, the released note that the private channel is not switched on.
