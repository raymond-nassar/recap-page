...
- `CHANGELOG.md:3785-3796`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3798-3808`, the released note that the private channel is not switched on.
