...
- `CHANGELOG.md:2912-2923`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2925-2935`, the released note that the private channel is not switched on.
