...
- `CHANGELOG.md:3546-3557`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3559-3569`, the released note that the private channel is not switched on.
