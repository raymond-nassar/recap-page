...
- `CHANGELOG.md:3063-3074`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3076-3086`, the released note that the private channel is not switched on.
