...
- `CHANGELOG.md:3465-3476`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3478-3488`, the released note that the private channel is not switched on.
