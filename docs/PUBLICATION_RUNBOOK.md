...
- `CHANGELOG.md:2914-2925`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2927-2937`, the released note that the private channel is not switched on.
