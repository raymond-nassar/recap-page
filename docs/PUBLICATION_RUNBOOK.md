...
- `CHANGELOG.md:3904-3915`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3917-3927`, the released note that the private channel is not switched on.
