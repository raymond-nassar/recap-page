...
- `CHANGELOG.md:2816-2819`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2828-2831`, the released note that the private channel is not switched on.
