...
- `CHANGELOG.md:4028-4039`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4041-4051`, the released note that the private channel is not switched on.
