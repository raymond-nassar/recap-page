...
- `CHANGELOG.md:4160-4171`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4173-4183`, the released note that the private channel is not switched on.
