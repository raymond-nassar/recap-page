...
- `CHANGELOG.md:3017-3021`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3023-3033`, the released note that the private channel is not switched on.
