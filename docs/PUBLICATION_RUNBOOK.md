...
- `CHANGELOG.md:3906-3917`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3919-3929`, the released note that the private channel is not switched on.
