...
- `CHANGELOG.md:3858-3869`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3871-3881`, the released note that the private channel is not switched on.
