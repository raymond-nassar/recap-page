...
- `CHANGELOG.md:3844-3855`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3857-3867`, the released note that the private channel is not switched on.
