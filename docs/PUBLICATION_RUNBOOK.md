...
- `CHANGELOG.md:3139-3150`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3152-3162`, the released note that the private channel is not switched on.
