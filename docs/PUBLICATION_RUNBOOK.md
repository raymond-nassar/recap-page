...
- `CHANGELOG.md:3616-3627`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3629-3639`, the released note that the private channel is not switched on.
