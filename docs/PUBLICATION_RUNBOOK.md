...
- `CHANGELOG.md:4057-4068`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4070-4080`, the released note that the private channel is not switched on.
