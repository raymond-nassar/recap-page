...
- `CHANGELOG.md:3628-3639`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3641-3651`, the released note that the private channel is not switched on.
