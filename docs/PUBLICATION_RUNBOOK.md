...
- `CHANGELOG.md:3288-3299`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3301-3311`, the released note that the private channel is not switched on.
