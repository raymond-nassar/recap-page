...
- `CHANGELOG.md:3294-3305`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3307-3317`, the released note that the private channel is not switched on.
