...
- `CHANGELOG.md:3747-3758`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3760-3770`, the released note that the private channel is not switched on.
