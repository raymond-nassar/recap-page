...
- `CHANGELOG.md:2877-2888`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2890-2900`, the released note that the private channel is not switched on.
