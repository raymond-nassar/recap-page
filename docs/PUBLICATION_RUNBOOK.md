...
- `CHANGELOG.md:3076-3087`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3089-3099`, the released note that the private channel is not switched on.
