...
- `CHANGELOG.md:3146-3157`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3159-3169`, the released note that the private channel is not switched on.
