...
- `CHANGELOG.md:3102-3113`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3115-3125`, the released note that the private channel is not switched on.
