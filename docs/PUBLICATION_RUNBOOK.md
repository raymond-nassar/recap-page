...
- `CHANGELOG.md:3398-3409`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3411-3421`, the released note that the private channel is not switched on.
