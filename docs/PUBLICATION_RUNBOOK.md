...
- `CHANGELOG.md:3159-3170`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3172-3182`, the released note that the private channel is not switched on.
