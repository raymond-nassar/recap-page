...
- `CHANGELOG.md:3152-3163`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3165-3175`, the released note that the private channel is not switched on.
