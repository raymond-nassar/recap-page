...
- `CHANGELOG.md:2968-2979`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2981-2991`, the released note that the private channel is not switched on.
