...
- `CHANGELOG.md:3456-3467`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3469-3479`, the released note that the private channel is not switched on.
