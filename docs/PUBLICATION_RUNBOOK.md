...
- `CHANGELOG.md:3354-3365`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3367-3377`, the released note that the private channel is not switched on.
