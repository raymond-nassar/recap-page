...
- `CHANGELOG.md:3898-3909`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3911-3921`, the released note that the private channel is not switched on.
