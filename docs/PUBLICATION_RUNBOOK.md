...
- `CHANGELOG.md:3690-3701`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3703-3713`, the released note that the private channel is not switched on.
