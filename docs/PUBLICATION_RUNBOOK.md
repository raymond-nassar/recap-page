...
- `CHANGELOG.md:3833-3844`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3846-3856`, the released note that the private channel is not switched on.
