...
- `CHANGELOG.md:2399-2402`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2411-2414`, the released note that the private channel is not switched on.
