...
- `CHANGELOG.md:3316-3327`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3329-3339`, the released note that the private channel is not switched on.
