...
- `CHANGELOG.md:3511-3522`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3524-3534`, the released note that the private channel is not switched on.
