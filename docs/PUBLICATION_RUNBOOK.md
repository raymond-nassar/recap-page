...
reasoning at `PRODUCT_BACKLOG.md:7097-7101`. The forms do not need editing. It is listed here
...
- `PRODUCT_BACKLOG.md:6861-6868`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6927-6929`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6949-6954`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6956-6962`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7023-7029`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7054-7059`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7097-7101`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9201-9206`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2483-2486`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2495-2498`, the released note that the private channel is not switched on.
