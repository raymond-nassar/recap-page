...
- `CHANGELOG.md:3359-3370`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3372-3382`, the released note that the private channel is not switched on.
