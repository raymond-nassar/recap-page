...
- `CHANGELOG.md:2899-2910`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2912-2922`, the released note that the private channel is not switched on.
