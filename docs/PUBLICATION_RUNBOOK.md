...
- `CHANGELOG.md:1970-1975`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:1963-1968`, the released note that the private channel is not switched on.
