...
- `CHANGELOG.md:3807-3818`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3820-3830`, the released note that the private channel is not switched on.
