...
- `CHANGELOG.md:2671-2674`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2684-2686`, the released note that the private channel is not switched on.
