...
- `PRODUCT_BACKLOG.md:6449-6462`, why secret scanning was left unticked, and what push protection
...
- `CHANGELOG.md:2582-2585`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2594-2597`, the released note that the private channel is not switched on.
