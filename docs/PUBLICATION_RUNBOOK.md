...
- `CHANGELOG.md:3125-3136`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3138-3148`, the released note that the private channel is not switched on.
