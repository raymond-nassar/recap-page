...
- `CHANGELOG.md:3726-3737`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3739-3749`, the released note that the private channel is not switched on.
