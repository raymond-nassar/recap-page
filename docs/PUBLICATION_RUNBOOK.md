...
- `CHANGELOG.md:3583-3594`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3596-3606`, the released note that the private channel is not switched on.
