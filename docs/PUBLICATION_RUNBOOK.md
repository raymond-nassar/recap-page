...
- `CHANGELOG.md:3912-3923`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3925-3935`, the released note that the private channel is not switched on.
