...
- `CHANGELOG.md:2800-2803`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2812-2815`, the released note that the private channel is not switched on.
