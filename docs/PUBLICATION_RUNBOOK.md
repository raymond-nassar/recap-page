...
- `CHANGELOG.md:3223-3234`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3236-3246`, the released note that the private channel is not switched on.
