...
- `CHANGELOG.md:2954-2965`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2967-2977`, the released note that the private channel is not switched on.
