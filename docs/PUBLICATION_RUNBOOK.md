...
- `CHANGELOG.md:4042-4053`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4055-4065`, the released note that the private channel is not switched on.
