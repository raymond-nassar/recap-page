...
- `CHANGELOG.md:3232-3243`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3245-3255`, the released note that the private channel is not switched on.
