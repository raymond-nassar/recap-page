...
- `CHANGELOG.md:2979-2990`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2992-3002`, the released note that the private channel is not switched on.
