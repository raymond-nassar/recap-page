...
- `CHANGELOG.md:4177-4188`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4190-4200`, the released note that the private channel is not switched on.
