...
- `CHANGELOG.md:2916-2927`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2929-2939`, the released note that the private channel is not switched on.
