...
- `CHANGELOG.md:3640-3651`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3653-3663`, the released note that the private channel is not switched on.
