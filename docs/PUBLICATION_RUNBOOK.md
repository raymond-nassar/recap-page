...
- `PRODUCT_BACKLOG.md:6453-6466`, why secret scanning was left unticked, and what push protection
  does when asked for without it.
- `PRODUCT_BACKLOG.md:6864-6871`, why the private reporting task was left open.
- `PRODUCT_BACKLOG.md:6930-6932`, what the changelog entry beside it was corrected to say.
- `PRODUCT_BACKLOG.md:6952-6957`, why the contribution guide is written in the future tense.
- `PRODUCT_BACKLOG.md:6959-6965`, why the code of conduct offers no private channel.
- `PRODUCT_BACKLOG.md:7026-7032`, why the branch rules task was left open and could not be read.
- `PRODUCT_BACKLOG.md:7057-7062`, why blank issues stay enabled.
- `PRODUCT_BACKLOG.md:7100-7104`, why `required: true` collects nothing today.
- `PRODUCT_BACKLOG.md:9204-9209`, the three settings named as refused on this repository today.
- `CHANGELOG.md:2556-2559`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2568-2571`, the released note that the private channel is not switched on.
