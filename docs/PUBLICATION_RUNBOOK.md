...
- `CHANGELOG.md:3935-3946`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3948-3958`, the released note that the private channel is not switched on.
