...
- `CHANGELOG.md:3269-3280`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3282-3292`, the released note that the private channel is not switched on.
