...
- `CHANGELOG.md:4078-4089`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4091-4101`, the released note that the private channel is not switched on.
