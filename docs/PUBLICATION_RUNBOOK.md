...
- `CHANGELOG.md:3850-3861`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3863-3873`, the released note that the private channel is not switched on.
