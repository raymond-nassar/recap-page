...
- `CHANGELOG.md:3392-3403`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3405-3415`, the released note that the private channel is not switched on.
