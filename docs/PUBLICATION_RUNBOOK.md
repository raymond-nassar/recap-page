...
- `CHANGELOG.md:2982-2984`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2986-2996`, the released note that the private channel is not switched on.
