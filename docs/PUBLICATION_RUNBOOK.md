...
- `CHANGELOG.md:3884-3895`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3897-3907`, the released note that the private channel is not switched on.
