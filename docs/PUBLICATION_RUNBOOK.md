...
- `CHANGELOG.md:3424-3435`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3437-3447`, the released note that the private channel is not switched on.
