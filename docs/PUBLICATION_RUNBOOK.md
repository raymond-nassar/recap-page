...
- `CHANGELOG.md:3365-3376`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3378-3388`, the released note that the private channel is not switched on.
