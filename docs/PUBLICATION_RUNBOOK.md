...
- `CHANGELOG.md:3958-3969`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3971-3981`, the released note that the private channel is not switched on.
