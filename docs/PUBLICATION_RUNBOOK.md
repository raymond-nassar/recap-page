...
- `CHANGELOG.md:3259-3270`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3272-3282`, the released note that the private channel is not switched on.
