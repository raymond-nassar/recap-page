...
- `CHANGELOG.md:2986-2997`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2999-3009`, the released note that the private channel is not switched on.
