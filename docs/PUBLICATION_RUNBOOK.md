...
- `CHANGELOG.md:4108-4119`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4121-4131`, the released note that the private channel is not switched on.
