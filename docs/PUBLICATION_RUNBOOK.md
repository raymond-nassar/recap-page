...
- `CHANGELOG.md:2931-2942`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2944-2954`, the released note that the private channel is not switched on.
