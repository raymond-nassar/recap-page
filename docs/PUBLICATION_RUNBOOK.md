...
- `CHANGELOG.md:3241-3252`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3254-3264`, the released note that the private channel is not switched on.
