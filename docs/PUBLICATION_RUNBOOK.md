...
- `CHANGELOG.md:3302-3313`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3315-3325`, the released note that the private channel is not switched on.
