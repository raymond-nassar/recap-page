...
- `CHANGELOG.md:3353-3364`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3366-3376`, the released note that the private channel is not switched on.
