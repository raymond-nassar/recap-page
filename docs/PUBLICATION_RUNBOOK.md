...
- `CHANGELOG.md:3132-3143`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3145-3155`, the released note that the private channel is not switched on.
