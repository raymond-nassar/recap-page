...
- `CHANGELOG.md:2958-2961`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2970-2973`, the released note that the private channel is not switched on.
