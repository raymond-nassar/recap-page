...
- `CHANGELOG.md:2680-2683`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2693-2695`, the released note that the private channel is not switched on.
