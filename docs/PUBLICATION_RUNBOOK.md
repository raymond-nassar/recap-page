...
- `CHANGELOG.md:3719-3730`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3732-3742`, the released note that the private channel is not switched on.
