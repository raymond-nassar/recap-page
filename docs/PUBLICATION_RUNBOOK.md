...
- `CHANGELOG.md:4065-4076`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4078-4088`, the released note that the private channel is not switched on.
