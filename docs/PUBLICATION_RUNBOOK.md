...
- `CHANGELOG.md:4072-4083`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:4085-4095`, the released note that the private channel is not switched on.
