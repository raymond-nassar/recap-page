...
- `CHANGELOG.md:3930-3941`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3943-3953`, the released note that the private channel is not switched on.
