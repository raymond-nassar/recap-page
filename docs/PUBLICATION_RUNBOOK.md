...
- `CHANGELOG.md:3662-3673`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3675-3685`, the released note that the private channel is not switched on.
