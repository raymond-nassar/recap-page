...
- `CHANGELOG.md:2881-2884`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:2893-2896`, the released note that the private channel is not switched on.
