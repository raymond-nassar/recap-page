...
- `CHANGELOG.md:3837-3848`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3850-3860`, the released note that the private channel is not switched on.
