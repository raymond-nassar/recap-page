...
- `CHANGELOG.md:3361-3372`, the released note that secret scanning cannot be turned on.
- `CHANGELOG.md:3374-3384`, the released note that the private channel is not switched on.
