...
reaches the interface in the reading hero at `src/js/main.js:2968` and the issue-details view at
`src/js/main.js:1780`. The function behind both already answers for the absence at
`src/js/main.js:3155-3164`, with a test asserting the sentence it returns. It is also reversible:
