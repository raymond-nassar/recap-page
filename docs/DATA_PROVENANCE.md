...
reaches the interface in the reading hero at `src/js/main.js:2427` and the issue-details view at
`src/js/views/issue.js:57`. The function behind both already answers for the absence at
`src/js/main.js:2634-2643`, with a test asserting the sentence it returns. It is also reversible:
