...
23,047 issue records covering 16,099 distinct issues. The visible files hold 22,560 of those records;
...
object of `path` and `ext`, and `creators` of `name` and `role`. Across all 256 payloads, 18,509
records carry a cover URL and 17,387 carry creator credits.
...
`src/data/curated-lists.json:5825-5863`, plus the 78-stop Marvel Knights to Planet X path generated
...
`src/data/catalog.json:9657-9782`.
