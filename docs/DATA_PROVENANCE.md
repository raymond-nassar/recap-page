...
reaches the interface in the reading hero at `src/js/main.js:3050` and the issue-details view at
`src/js/main.js:1862`. The function behind both already answers for the absence at
`src/js/main.js:3237-3246`, with a test asserting the sentence it returns. It is also reversible:
