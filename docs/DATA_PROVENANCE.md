...
| Compiled for this project from Comic Book Herald's guide | 129 | The guide's issue selection and sequence, re-expressed as local checklists. Every visible card links to the exact guide followed |
...
The 184 source orders generate 261 visible Reading Lists. Marvel Knights to Planet X is the only
...
`src/data/curated-lists.json:6045-6083`, plus the 78-stop Marvel Knights to Planet X path generated
...
`src/data/catalog.json:9919-10044`.
