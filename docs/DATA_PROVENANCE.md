...
reaches the interface in the reading hero at `src/js/main.js:2865` and the issue-details view at
`src/js/main.js:1677`. The function behind both already answers for the absence at
`src/js/main.js:3052-3061`, with a test asserting the sentence it returns. It is also reversible:
