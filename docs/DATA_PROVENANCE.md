...
reaches the interface in the reading hero at `src/js/main.js:3082` and the issue-details view at
`src/js/main.js:1894`. The function behind both already answers for the absence at
`src/js/main.js:3269-3278`, with a test asserting the sentence it returns. It is also reversible:
