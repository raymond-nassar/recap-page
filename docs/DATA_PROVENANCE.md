...
Marvel origin and its actual route at `src/index.html:1017`. Redistributing Content outside an App, and sublicensing it onward, are the
...
reaches the interface in the reading hero at `src/js/views/reading.js:562` and the issue-details view at
