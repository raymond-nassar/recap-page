...
Marvel origin and its actual route at `src/index.html:972`. Redistributing Content outside an App, and sublicensing it onward, are the
...
reaches the interface in the reading hero at `src/js/views/reading.js:459` and the issue-details view at
