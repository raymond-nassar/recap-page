...
22,829 issue records covering 16,030 distinct issues. The visible files hold 22,342 of those records;
...
object of `path` and `ext`, and `creators` of `name` and `role`. Across all 254 payloads, 18,309
records carry a cover URL and 17,194 carry creator credits.
...
included. The relationship approval covers all 175 other source orders, including 21 partial
