...
22,956 issue records covering 16,091 distinct issues. The visible files hold 22,469 of those records;
...
object of `path` and `ext`, and `creators` of `name` and `role`. Across all 255 payloads, 18,436
records carry a cover URL and 17,321 carry creator credits.
...
Of the visible records, 1,000 are unopenable placeholders for unresolved source positions and 199
non-placeholder records carry neither a series ID nor a digital ID after an upstream refusal. Those
1,199 gap positions affect 25 catalog entries: ten carry placeholders, nineteen carry empty records, and
