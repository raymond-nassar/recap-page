...
reaches the interface in the reading hero at `src/js/main.js:2430` and the issue-details view at
`src/js/views/issue.js:57`. The function behind both already answers for the absence at
`src/js/main.js:2637-2646`, with a test asserting the sentence it returns. It is also reversible:
