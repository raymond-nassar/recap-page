...
23,217 issue records covering 16,212 distinct issues. The visible files hold 22,730 of those records;
...
object of `path` and `ext`, and `creators` of `name` and `role`. Across all 257 payloads, 18,664
records carry a cover URL and 17,526 carry creator credits.
...
`src/data/curated-lists.json:5860-5898`, plus the 78-stop Marvel Knights to Planet X path generated
...
`src/data/catalog.json:9699-9824`.
