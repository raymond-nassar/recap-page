...
reaches the interface in the reading hero at `src/js/main.js:3034` and the issue-details view at
`src/js/main.js:1845`. The function behind both already answers for the absence at
`src/js/main.js:3221-3230`, with a test asserting the sentence it returns. It is also reversible:
