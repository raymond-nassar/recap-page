...
reaches the interface in the reading hero at `src/js/main.js:3054` and the issue-details view at
`src/js/main.js:1866`. The function behind both already answers for the absence at
`src/js/main.js:3241-3250`, with a test asserting the sentence it returns. It is also reversible:
