...
`src/js/main.js:2098-2113`. An in-flight synopsis run is cancelled and its tab-memory prose is
...
`src/js/main.js:1822-1833`, so browsing does not depend on the metadata service.
...
refresh fan-out at `src/js/main.js:2530-2552`, including the rail, reading view, Home, Library hub
