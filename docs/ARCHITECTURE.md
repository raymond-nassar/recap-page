...
`src/js/main.js:2092-2107`. An in-flight synopsis run is cancelled and its tab-memory prose is
...
`src/js/main.js:1821-1832`, so browsing does not depend on the metadata service.
...
refresh fan-out at `src/js/main.js:2524-2546`, including the rail, reading view, Home, Library hub
...
refresh at `src/js/main.js:2524-2546`. That refresh leaves cards, controls, focus, scroll and
