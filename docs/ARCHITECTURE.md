...
`src/js/main.js:3143-3194`. The selected id lives only in the validated `path` query of the hash
...
`src/js/main.js:3054-3086`, while the existing Store-driven render path calls the position-only
