...
| `sidebar.collapsed` | the sidebar toggle, at `src/js/main.js:1024` | nothing | Whether the rail is collapsed. Wrapped in its own try, because losing it is not worth an error. |
