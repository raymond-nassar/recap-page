...
open metadata gaps linked to Issue #283, and one exclusion. The complete-library review covers 148
existing reading lists: three are existing-subset relationships, 25 are partial, and 120 have no
shared issue.
