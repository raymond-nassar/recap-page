...
| C9 | Current dated research citations of README lines originate in four commits, and one artifact contains three origins. | `.copilot-tracking/research/subagents/2026-08-20/modern-marvel-continuity-guides-internal-wider.md:41-79` | git blame | high | Disproves one source commit per document. |
