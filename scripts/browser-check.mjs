  ...
  },
  {
    ...
    async run(page, t) {
      ...
      t.check('desktop All, Complete, and Best of counts classify Adam exactly once',
        desktop.all.readings === 49 && desktop.all.stories === 48
        && desktop.all.cards === 48 && desktop.all.adamCards === 1
      ...
      t.check('narrow All, Complete, and Best of counts preserve Adam without horizontal overflow',
        narrow.all.readings === 49 && narrow.all.stories === 48
        && narrow.all.cards === 48 && narrow.all.adamCards === 1
