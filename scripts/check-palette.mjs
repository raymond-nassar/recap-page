...
export const PAIRS = [
  ...
  // (`src/styles.css:794` and `src/styles.css:796`), which is 1.93:1 in the dark theme. It is
...
export const SURFACES = {
  ...
  'the unreadable-data banner': {
    ...
    fraction: 0.12,
    on: '--panel',
    css: 'color-mix(in srgb, var(--warn) 12%, var(--panel)), at `src/styles.css:1583`',
  },
...
// stated as text beside it, at `src/js/main.js:1944` in the rail and `src/js/main.js:6646` in the
// saved lists.
//
