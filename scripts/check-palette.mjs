...
// stated as text beside it, at `src/js/main.js:1654` in the rail and `src/js/views/shared/saved-lists.js:31` in the
// saved lists.
//
...
export const KNOWN = [
  ...
  // the button takes its accessible name from the `aria-label` at   `src/js/views/reading.js:793`, which
  // replaces the glyph in the name computation, and `aria-pressed` at   `src/js/views/reading.js:792`
