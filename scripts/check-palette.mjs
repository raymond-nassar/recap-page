...
// stated as text beside it, at `src/js/main.js:1302` in the rail and `src/js/main.js:5187` in the
// saved lists.
//
...
export const KNOWN = [
  ...
  // the button takes its accessible name from the `aria-label` at `src/js/main.js:2666`, which
