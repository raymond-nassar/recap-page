...
test('the bundled orders carry a gap the payload field never reported', () => {
  ...
  // Magneto adds 58 cached-provider gaps. Loki adds 18 distinct source-occurrence gaps. Moon Knight adds 18 more.
...
test('the bundled orders really do contain issues no lookup can answer for', () => {
  ...
  // source occurrences without duplicate identifiers. Magneto adds 58. Loki adds 18. Moon Knight adds 18.
