...
// The test above reads the catalog, so it sees exactly the one hundred and thirty-eight files the catalog names and
...
// leaves the population with nothing said. A floor of one hundred and thirty-eight still passes at that point,
// because the catalog's own files alone clear it. An exact one hundred and forty-one does not.
//
