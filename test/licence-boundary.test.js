...
// The test above reads the catalog, so it sees exactly the one hundred and forty-two files the catalog names and
...
// because the catalog's own files alone clear it. An exact one hundred and forty-five does not.
//
