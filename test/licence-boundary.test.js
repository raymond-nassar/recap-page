...
// The test above reads the catalog, so it sees exactly the one hundred and forty files the catalog names and
...
// leaves the population with nothing said. A floor of one hundred and forty still passes at that point,
// because the catalog's own files alone clear it. An exact one hundred and forty-three does not.
//
